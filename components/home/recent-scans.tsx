  ...
  return (
    ...
    >
      <div className="border-border bg-card/40 rounded-2xl border p-5 sm:p-6">
        ...
        {history.length === 0 ? (
          <div className="border-border/70 flex flex-col items-center justify-center gap-1 rounded-xl border border-dashed py-10 text-center">
            <Clock className="text-muted-foreground/60 size-5" aria-hidden="true" />
            <p className="text-muted-foreground text-sm">Your recent scans will appear here.</p>
            <p className="text-muted-foreground text-xs">Stored locally on your device only.</p>
          </div>
        ) : (
